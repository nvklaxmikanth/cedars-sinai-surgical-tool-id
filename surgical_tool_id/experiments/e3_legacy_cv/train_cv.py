"""Train the legacy SmallCNN independently on E2's video-grouped folds.

Run one fold per process for isolated peak-memory measurements:
    python experiments/e3_legacy_cv/train_cv.py --fold 0
Then aggregate:
    python experiments/e3_legacy_cv/train_cv.py --aggregate
"""
