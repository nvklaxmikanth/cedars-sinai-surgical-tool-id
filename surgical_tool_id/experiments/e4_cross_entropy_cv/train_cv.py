"""Train the E3 SmallCNN with raw-logit cross entropy on E2 video folds.

Run one fold per process for isolated peak-memory measurements:
    python experiments/e4_cross_entropy_cv/train_cv.py --fold 0
Then aggregate:
    python experiments/e4_cross_entropy_cv/train_cv.py --aggregate
"""
